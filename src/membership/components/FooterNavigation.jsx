  ...
  return (
    <div className="absolute w-full bottom-0 left-0 py-5 px-max  text-neutral-50 bg-neutral-950 border-t border-neutral-700 z-[9999] text-xs md:text-lg">
      <div className="flex justify-between items-center relative md:top-1 ">
        <a href="/contact" className="font-inter uppercase flex items-center group cursor-pointer">
        ...
        <p className="font-inter uppercase flex items-center group cursor-pointer ">
          <p className="hover:tracking-widest text-sm md:text-lg hover:text-neutral-300 transition-all ease-in-out duration-200">Notice</p>
        </p>
        <a
          href="/faq"
