...
// The background colors used in the 'imageUrl' are for the UI-Avatars service
// and only determine the initial avatar color, not the final border color in the UI.
        ...
        members: [
            {
                ...
                email: "kaushik.sharma@xim.edu.in",
                linkedin: "https://linkedin.com/in/kaushik-sharma",
                github: "https://github.com/kaushikdev",
                imageUrl:
                    "https://ui-avatars.com/api/?name=Kaushik+Sharma&background=2563eb&color=fff&size=256" 
            },
            {
                name: "Siddhant Pradhan",
                role: "Vice Chairperson",
                tag: "Operations & Outreach",
                email: "riya.sen@xim.edu.in",
                linkedin: "https://linkedin.com/in/riya-sen",
                github: "https://github.com/riyasen",
                imageUrl:
                    "https://ui-avatars.com/api/?name=Riya+Sen&background=db2777&color=fff&size=256" 
            },
            {
                name: "Priyanshu",
                role: "Secretary",
...
const GeneralMemberCard = ({ member, colorClass }) => {
    const accentColor = colorClass.split('-')[1]; // Extracts color name for hover border
...
const TeamCard = ({ member, sectionTitle }) => {
    ...
    // --- Image Ring Style (Unified Black and Thin) ---
    // p-[2px] for a slightly thicker but still thin ring for prominence
    // bg-black for the black border color
